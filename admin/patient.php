...
<div id="container">
		...
		<h1 style="text-align: center; color:Red">Appointment List</h1><br><br>
		...
		<center>
			...
			<tr>
				...
				<th width="200" height="50" style="text-align:center">Doctor-Name</th>
				
			</tr>
			<?php


				$q = "select * from apoint";
				...
				<tr>
					...
					<td width="200" height="50"><center><?php echo $dname?></center></td>
